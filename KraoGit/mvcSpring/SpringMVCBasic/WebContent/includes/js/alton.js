...
(function ($) {
    ...
    $.fn.alton = function (options) {
        ...
        $.fn.scrollTo = function (element) {
            if (element !== last) {
                $("body,html").stop(true, true).animate({scrollTop: $(element).offset().top}, {duration: 650});
            } else {
                $("body,html").stop(true, true).animate({scrollTop: $(document).outerHeight() - windowHeight}, {duration: 650});
            }
        };
